...
app.use((req, res, next) => {
  res.setHeader("X-TRACE-Build", "trace-v46-english-auth-network-fix");
  next();
});
...
const SOCIAL_BUILD = "trace-v46-english-auth-network-fix";
...
app.get("/health", (req, res) => {
  ...
  return res.json({
    ok: true,
    build: "trace-v46-english-auth-network-fix",
    ts: Date.now(),
