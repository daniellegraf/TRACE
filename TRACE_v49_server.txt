...
app.use((req, res, next) => {
  res.setHeader("X-TRACE-Build", "trace-v49-auth-transport-diagnostics");
  next();
});
...
const SOCIAL_BUILD = "trace-v49-auth-transport-diagnostics";
...
app.get("/health", (req, res) => {
  ...
  return res.json({
    ok: true,
    build: "trace-v49-auth-transport-diagnostics",
    ts: Date.now(),
