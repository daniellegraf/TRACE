...
app.use((req, res, next) => {
  res.setHeader("X-TRACE-Build", "trace-v45-top-nav-silent-signing-required-origin");
  next();
});
...
const SOCIAL_BUILD = "trace-v45-top-nav-silent-signing-required-origin";
...
app.get("/health", (req, res) => {
  ...
  return res.json({
    ok: true,
    build: "trace-v45-top-nav-silent-signing-required-origin",
    ts: Date.now(),
